...
$idDaNoticia = $_GET['id'];
$noticia = $noticiasController->listarNoticiaPorID($idDaNoticia); // Assuming this retrieves a single article
...
<head>
    ...
    <link rel="stylesheet" href="public/CSS/ler-noticia.css">
...
<div class="grid">
        ...
        <section>
            ...
            <div class="le">
                <img src="../uploads/<?php echo $noticia['imagem'] ?>" alt="Imagem do noticia">
            </div>
            <div class="ld">
                <div class="titulo"><p><?php echo $noticia['titulo'] ?></p></div>
                <div class="conteudo"><p><?php echo $noticia['conteudo'] ?></p></div>
            </p>
            </div>
            <div class="lb">
                <p>Data:<?php echo $noticia['data'] ?></p>
            </div>
        </section>
        <footer>
            <div class="contato">
